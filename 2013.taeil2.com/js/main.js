...
$("#backgroundNav, #backgroundNavMobile").click(function() {
    $('html, body').animate({
        scrollTop: $("#backgroundSection").offset().top - 40
    }, 500);
});
$("#skillsNav, #skillsNavMobile").click(function() {
    $('html, body').animate({
        scrollTop: $("#skillsSection").offset().top - 40
    }, 500);
});
$("#workNav, #workNavMobile").click(function() {
    $('html, body').animate({
        scrollTop: $("#workSection").offset().top - 40
    }, 500);
});
$("#contactNav, #contactNavMobile").click(function() {
    $('html, body').animate({
